...
/*Execute tout les crons contenu dans la bdd si l'intervalle de temps voulu est dépassé s'execute tout les jours, voir sudo crontab -e*/
class CronTasksRunCommand extends ContainerAwareCommand
{
    ...
    protected function execute(InputInterface $input, OutputInterface $output)
    {
        ...
        $crontasks = $em->getRepository('MbMainBundle:CronTask')->findAll();
